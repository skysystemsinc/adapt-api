...
import { ProfessionalQualification } from "./professional-qualification.entity";

@Entity('professional_qualifications_history')
export class ProfessionalQualificationHistory {
    ...
    @ManyToOne(() => ProfessionalQualification, { onDelete: 'CASCADE' })
    @JoinColumn({ name: 'professionalQualificationId' })
