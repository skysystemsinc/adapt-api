...
import { StorageFacilitiesEntity } from "./storage-facilities.entity";

@Entity('storage_facilities_checklist_history')
export class StorageFacilitiesHistoryEntity {
    @PrimaryGeneratedColumn('uuid')
    id: string;

    @Column({ type: 'uuid' })
    storageFacilitiesId: string;

    @ManyToOne(() => StorageFacilitiesEntity, { onDelete: 'CASCADE' })
