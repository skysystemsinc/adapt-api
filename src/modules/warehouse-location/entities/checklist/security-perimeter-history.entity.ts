...
import { SecurityPerimeterEntity } from "./security-perimeter.entity";

@Entity('security_perimeter_checklist_history')
export class SecurityPerimeterHistoryEntity {
    @PrimaryGeneratedColumn('uuid')
    id: string;

    @Column({ type: 'uuid' })
    securityPerimeterId: string;

    @ManyToOne(() => SecurityPerimeterEntity, { onDelete: 'CASCADE' })
