...
import { InfrastructureUtilitiesEntity } from "./infrastructure-utilities.entity";

@Entity('infrastructure_utilities_checklist_history')
export class InfrastructureUtilitiesHistoryEntity {
    @PrimaryGeneratedColumn('uuid')
    id: string;

    @Column({ type: 'uuid' })
    infrastructureUtilitiesId: string;

    @ManyToOne(() => InfrastructureUtilitiesEntity, { onDelete: 'CASCADE' })
