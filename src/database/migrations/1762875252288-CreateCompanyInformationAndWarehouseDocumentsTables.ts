...
export class CreateCompanyInformationAndWarehouseDocumentsTables1762875252288 implements MigrationInterface {
    name = 'CreateCompanyInformationAndWarehouseDocumentsTables1762875252288'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "company_information" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "applicationId" uuid, "companyName" character varying(200) NOT NULL, "secpRegistrationNumber" character varying(200) NOT NULL, "activeFilerStatus" boolean NOT NULL, "dateOfIncorporation" date NOT NULL, "businessCommencementDate" date, "registeredOfficeAddress" text NOT NULL, "postalCode" character varying(10), "nationalTaxNumber" character varying(100) NOT NULL, "ntcCertificate" uuid, "salesTaxRegistrationNumber" character varying(100) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ac715e6016ab035fa3b0611a4da" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "company_information" ADD CONSTRAINT "FK_20da6ea753d9702277d745364bf" FOREIGN KEY ("ntcCertificate") REFERENCES "warehouse_documents"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "company_information" DROP CONSTRAINT "FK_20da6ea753d9702277d745364bf"`);
